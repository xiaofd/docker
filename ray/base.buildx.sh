...
docker buildx build -t xiaofd/ray:base -f Dockerfile --platform linux/amd64,linux/arm64,linux/arm/v7,linux/386 -o type=registry -f Dockerfile.base .
docker buildx build -t xiaofd/ray:base-alpine -f Dockerfile --platform linux/amd64,linux/arm64,linux/arm/v7,linux/386 -o type=registry -f Dockerfile.base.alpine .
